...
class RayPPOTrainer(object):
    ...
    def _create_dataloader(self):
        ...
        self.train_dataset = ReFTDataset(parquet_files=self.config.data.train_files,
        ...
        self.val_dataset = ReFTDataset(parquet_files=self.config.data.val_files,
                                       tokenizer=self.tokenizer,
                                       prompt_key=self.config.data.prompt_key,
                                       max_prompt_length=self.config.data.max_prompt_length,
                                       filter_prompts=True,
        ...
        self.val_dataloader = StatefulDataLoader(
            ...
            batch_size= len(self.val_dataset), #self.config.data.val_batch_size, #len(self.val_dataset),### tx 自定义一下试试
            shuffle=False,
            drop_last=False,
            collate_fn=collate_fn)
